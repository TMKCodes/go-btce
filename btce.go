...
func New(public string, secret string) {
	pub := NewPublic();
...
func (this *btce) TradeHistory(From int, Count int, FromID int, EndID, int, Order string, Since string, End string) (*tradeHistory, error) {
	return this.Private.TradeHistory(From, Count, FromID, EndID, Order, Since, End);
}
...
func (this *btce) Depth(Pair string) (*trades, error) {
